...
export default function EditTransactionScreen() {
  ...
  useEffect(() => {
    ...
    if (transactionId) {
      ...
      if (foundTransaction) {
        ...
        setReceiptImage(foundTransaction.receiptUrl || null)
        setIsRecurring(foundTransaction.isRecurring)
        setRecurringFrequency(foundTransaction.recurringFrequency || "monthly")
      } else {
  ...
  const handleUpdateTransaction = async () => {
    ...
    try {
      // Check if receipt image is a URL or a local file path
      let newReceiptImage = undefined
      if (receiptImage && !receiptImage.startsWith("http")) {
        newReceiptImage = receiptImage
      }
